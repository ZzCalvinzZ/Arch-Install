...
sudo pacman -S xorg xorg-xinit i3 feh tmux rofi ranger arandr xss-lock dunst powertop
...
sudo pacman -S xdg-user-dirs acpid simplescreenrecorder xfce4-power-manager cups system-config-printer
...
pacaur -S google-chrome firefox-developer-edition nerd-fonts-complete ttf-google-fonts-git laptop-mode-tools slack-desktop zsh-pure-prompt spotify dropbox autorandr alarm-clock-applet gst-plugins-good thunderbird zeal
